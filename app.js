...
const MENU = [
  ...
  // TAPIOCA
  { id:29, category:"tapioca", name:"Carne de Sol com Catupiry", description:"Tapioca recheada com carne de sol e catupiry",              price:8, image:"imagem/tapioca.avif", badge:null, modifiers:[] },
  { id:30, category:"tapioca", name:"Carne de Sol com Queijo",   description:"Tapioca recheada com carne de sol e queijo",               price:8, image:"imagem/tapioca.avif", badge:null, modifiers:[] },
  { id:31, category:"tapioca", name:"Frango com Catupiry",       description:"Tapioca recheada com frango e catupiry",                   price:8, image:"imagem/tapioca.avif", badge:null, modifiers:[] },
  { id:32, category:"tapioca", name:"Frango com Queijo",         description:"Tapioca recheada com frango e queijo",                     price:8, image:"imagem/tapioca.avif", badge:null, modifiers:[] },
  { id:33, category:"tapioca", name:"Carne de Sol na Nata",      description:"Tapioca recheada com carne de sol na nata",                price:9, image:"imagem/tapioca.avif",   badge:null, modifiers:[] },
  { id:34, category:"tapioca", name:"Sertaneja",                 description:"Tapioca recheada com carne de sol, queijo coalho e coentro",price:9, image:"imagem/tapioca.avif", badge:null, modifiers:[] },

  // CUSCUZ
  { id:35, category:"cuscuz", name:"Carne de Sol com Queijo", description:"Cuscuz recheado com carne de sol e queijo",  price:8, image:"imagem/cuscuzcarnenata.jpg", badge:null, modifiers:[] },
  { id:36, category:"cuscuz", name:"Frango com Queijo",       description:"Cuscuz recheado com frango e queijo",        price:8, image:"imagem/cuscuzfrango.jpg", badge:null, modifiers:[] },
  { id:37, category:"cuscuz", name:"Calabresa",               description:"Cuscuz recheado com calabresa e queijo",     price:8, image:"imagem/cuscuzcalabresa.jpg", badge:null, modifiers:[] },
  { id:38, category:"cuscuz", name:"Carne de Sol na Nata",    description:"Cuscuz recheado com carne de sol na nata",   price:9, image:"imagem/cuscuzcarnenata.jpg",   badge:null, modifiers:[] },

  // CACHORRO-QUENTE
  { id:39, category:"cachorro-quente", name:"Tradicional",   description:"Pão, carne moída, salsicha, frango, batata palha, milho, ervilha e queijo ralado",        price:7, image:"imagem/hotdog.webp", badge:null,      modifiers:[] },
  { id:40, category:"cachorro-quente", name:"Carne na Nata", description:"Pão, carne de sol na nata, salsicha, milho, ervilha, batata palha e queijo ralado",        price:9, image:"imagem/Cachorro-quente-nata.jpg", badge:"ESPECIAL", modifiers:[] },
  ...
  { id:48, category:"pizzas", name:"Pizza Frango com Bacon",    description:"Frango desfiado, cebola, bacon, queijo mussarela, orégano, azeitona e molho de tomate",                  price:30, image:"imagem/pizza-de-frango-com-bacon.png", badge:null,      modifiers:[pizzaModifier] },
  { id:49, category:"pizzas", name:"Pizza Frango com Milho",    description:"Frango desfiado, cebola, milho verde, queijo mussarela, orégano, azeitona e molho de tomate",            price:30, image:"imagem/pizza-de-frangomilho.jpg", badge:null,      modifiers:[pizzaModifier] },
  { id:50, category:"pizzas", name:"Pizza Frango com Catupiry", description:"Frango desfiado, catupiry, cebola, queijo mussarela, orégano, azeitona e molho de tomate",               price:30, image:"imagem/pizza-de-frango-com-catupiry.webp", badge:null,      modifiers:[pizzaModifier] },
  { id:51, category:"pizzas", name:"Pizza Frango com Cheddar",  description:"Frango desfiado, cheddar, cebola, queijo mussarela, orégano, azeitona e molho de tomate",                price:30, image:"imagem/pizzafrangochedar.jpg", badge:null,      modifiers:[pizzaModifier] },
  { id:52, category:"pizzas", name:"Pizza Frango com Queijo",   description:"Frango desfiado, cebola, queijo mussarela, orégano, azeitona e molho de tomate",                         price:30, image:"imagem/pizza-de-frango-queijo.webp", badge:null,      modifiers:[pizzaModifier] },
  { id:53, category:"pizzas", name:"Pizza Moda da Casa",        description:"Carne de sol desfiada, frango, calabresa, cebola, queijo mussarela, orégano, azeitona e molho de tomate",price:40, image:"imagem/pizzamodadacasa.jpg", badge:"ESPECIAL", modifiers:[pizzaModifier] },
  { id:54, category:"pizzas", name:"Pizza Carne com Catupiry",  description:"Carne desfiada, catupiry, cebola, queijo mussarela, orégano, azeitona e molho de tomate",                price:35, image:"imagem/pizzacarnedesolcatupiry.webp", badge:null,      modifiers:[pizzaModifier] },
  { id:55, category:"pizzas", name:"Pizza Carne de Sol",        description:"Carne de sol desfiada, cebola, queijo mussarela, orégano, azeitona e molho de tomate",                   price:35, image:"imagem/pizzacarnesol.jpg", badge:null,      modifiers:[pizzaModifier] },
  { id:56, category:"pizzas", name:"Pizza Carne com Cheddar",   description:"Carne desfiada, cheddar, cebola, queijo mussarela, orégano, azeitona e molho de tomate",                 price:35, image:"imagem/pizza-carne-chedar.webp", badge:null,      modifiers:[pizzaModifier] },
  { id:57, category:"pizzas", name:"Pizza Sertaneja",           description:"Carne de sol desfiada, cebola, queijo coalho, queijo mussarela, orégano, azeitona e molho de tomate",    price:35, image:"imagem/pizza-sertaneja.jpg", badge:null,      modifiers:[pizzaModifier] },
